...
export const AFFILIATED_COLLEGES = {
  ...
  "Osmania University": [
    "University College of Engineering (UCEOU)",
    "University College of Technology (UCTOU)",
    "Nizam College",
  ...
  "Indian Institute of Technology (IIT)": [
    "IIT Bombay", "IIT Delhi", "IIT Madras", "IIT Kanpur", "IIT Kharagpur", "IIT Roorkee", "IIT Guwahati", "IIT BHU", "IIT Hyderabad", "IIT Indore", "IIT Gandhinagar", "IIT Ropar", "Not Listed / Other"
  ],
  "Indian Institute of Management (IIM)": [
    "IIM Ahmedabad", "IIM Bangalore", "IIM Calcutta", "IIM Lucknow", "IIM Indore", "IIM Kozhikode", "IIM Shillong", "IIM Rohtak", "IIM Udaipur", "IIM Trichy", "Not Listed / Other"
  ],
  "National Institute of Technology (NIT)": [
    "NIT Trichy", "NIT Surathkal", "NIT Warangal", "NIT Calicut", "NIT Rourkela", "NIT Kurukshetra", "NIT Durgapur", "NIT Silchar", "NIT Jamshedpur", "NIT Jaipur", "Not Listed / Other"
  ]
};
